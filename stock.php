        ...
        <table class="table mr-5">
            ...
            <form action="#" method="post">
                <tr>
                    ...
                    <td>
                        <button type="submit" class=" col-12 btn btn-primary mb-3">Ajouter</button>
                    </td>
            ...
            if ($count['COUNT(*)'] > 0) {
                do {
                    ...
                    <tr>
                        ...
                        <td><a href="edit.php?id=<?php echo $row['id'] ?>" class="btn btn-warning ">
                            ...
                            <a href="action-delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
